...
public class SoporteCentralizadoController {
	...
	@PostMapping("/consultaTicketSoporteSeguimiento")
	public ResponseEntity<?> consultaTicketSoporteSeguimiento(@RequestBody String params) {
		logger.info("#### SEGUIMIENTO SOPORTE consultaTicketSoporteSeguimiento ### \n" + params);
		ServiceResponseResult response = soporteCentralizadoService.consultaTicketSoporteSeguimiento(params);
		if (response.getResult() instanceof Integer) {
			return new ResponseEntity<>(response, HttpStatus.FORBIDDEN);
		}
		return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
	...
	@PostMapping("/consultaIngenierosSoporte")
	public ResponseEntity<?> consultaIngenierosSoporte(@RequestBody String params) {
		logger.info("#### consultaIngenierosSoporte ### \n" + params);
		ServiceResponseResult response = soporteCentralizadoService.consultarIngenierosSoporte(params);
		if (response.getResult() instanceof Integer) {
			return new ResponseEntity<>(response, HttpStatus.FORBIDDEN);
		}
		return new ResponseEntity<>(response, HttpStatus.ACCEPTED);
