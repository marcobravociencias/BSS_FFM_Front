            ...
            if (ordenesArray.size() > 0) {
                if (jsonObjectResponse.get("registrosTotales").getAsInt() > 0) {
                    ...
                    for (int i = 0; i < ordenesArray.size(); i++) {
                        ...
                        dataArray[count][2] = object.get("tipo") != null && object.get("tipo").getAsString() != "" ? object.get("tipo").getAsString().trim() : "";
                        dataArray[count][3] = object.get("subTipo") != null && object.get("subTipo").getAsString() != "" ? object.get("subTipo").getAsString().trim() : "";
                        dataArray[count][4] = object.get("estatusOrden") != null && object.get("estatusOrden").getAsString() != "" ? object.get("estatusOrden").getAsString().trim() : "";
                        dataArray[count][5] = object.get("estadoOrden") != null && object.get("estadoOrden").getAsString() != "" ? object.get("estadoOrden").getAsString().trim() : "";
                        dataArray[count][6] = object.get("motivoOrden") != null && object.get("motivoOrden").getAsString() != "" ? object.get("motivoOrden").getAsString().trim() : "";
                        dataArray[count][7] = object.get("ciudad") != null && object.get("ciudad").getAsString() != "" ? object.get("ciudad").getAsString().trim() : "";
                        dataArray[count][8] = object.get("estado") != null && object.get("estado").getAsString() != "" ? object.get("estado").getAsString().trim() : "";
                        dataArray[count][9] = object.get("numEmpleadoTecnico") != null && object.get("numEmpleadoTecnico").getAsString() != "" ? object.get("numEmpleadoTecnico").getAsString().trim() : "";
                        dataArray[count][10] = object.get("usuarioTecnico") != null && object.get("usuarioTecnico").getAsString() != "" ? object.get("usuarioTecnico").getAsString().trim() : "";
                        dataArray[count][11] = object.get("nombreTecnico") != null && object.get("nombreTecnico").getAsString() != "" ? object.get("nombreTecnico").getAsString().trim() : "";
                        dataArray[count][12] = object.get("fechaUltimaAgenda") != null && object.get("fechaUltimaAgenda").getAsString() != "" ? object.get("fechaUltimaAgenda").getAsString().trim() : "";
                        dataArray[count][13] = object.get("fechaFin") != null && object.get("fechaFin").getAsString() != "" ? object.get("fechaFin").getAsString().trim() : "";
        ...
        if (ordenesArray.size() > 0) {
            if (jsonObjectResponse.get("registrosTotales").getAsInt() > 0) {
                for (int i = 0; i < ordenesArray.size(); i++) {
                    ...
                    result.addProperty("ESTADO", object.get("estado") != null && object.get("estado").getAsString() != "" ? object.get("estado").getAsString() : "");
