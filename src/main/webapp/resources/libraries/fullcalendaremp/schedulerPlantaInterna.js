...
TimelineGrid = (function(superClass) {
  ...
  TimelineGrid.prototype.fgSegHtml = function(seg, disableResizing) {
    ...
    var clase_hover="hover_date_less_3_hours";
    if( !(event.start._i instanceof Array) ){
      if( event.start !== null && event.end !== null){
          var date_start=new Date(event.start._i);
          var date_end=new Date(event.end._i);
          //Calcula la diferencia en horas entre 2 fechas
          var hours = Math.floor(Math.abs(date_start - date_end) / 36e5);
          if(hours >=3 ){
            clase_hover=""
          }
      }
...
Spreadsheet = (function() {
  ...
  Spreadsheet.prototype.renderHeadHtml = function() {
    ...
    for (i = k = 0, len1 = colSpecs.length; k < len1; i = ++k) {
      ...
      html += '<th class="' + this.view.widgetHeaderClass + '">' + '<div>' + '<div class="fc-cell-content">' + (o.isMain ? '<span class="fc-expander-space">' + '<span class="fc-icon"></span>' + '</span>' : '') + '<span class="fc-cell-text" data-step="24" ><b>' + htmlEscape(o.labelText || '') + '</b></span>' + '</div>' + (!isLast ? '<div class="fc-col-resizer"></div>' : '') + '</div>' + '</th>';
    }
    html += '</tr>';
    html += '</tbody></table>';
    return html;
              ...
              <div class="row">
                  <div  class="col-12 content-icons-operario ">
                      ...
                      <div class="icon-content-operario tooltip-icon-des">
                          ...
                          <span class="icono_operario_accion fa fa-info-circle" onclick="abrirOtsTrabajadas('${resource.idTecnico}');" ></span>
                      </div>
                      <div class="icon-content-operario tooltip-icon-des">
                          <span class="tooltiptext-icon-des">Ubicaci\u00F3n operario</span>
                          <span class="icono_operario_accion fa fa-map"  onclick="abrirUbicacionOperario('${resource.idTecnico}');"></span>
                      </div>
                      <div class="icon-content-operario tooltip-icon-des style3">
                          <span class="tooltiptext-icon-des">Informaci\u00F3n veh\u00EDculo</span>
                          <span class="icono_operario_accion fa fa-car"  onclick="abrirInformacionVehiculo('${resource.idTecnico}')" ></span>
                      </div>     
                      <div class="icon-content-operario tooltip-icon-des">
                      ...
                      <div class="icon-content-operario tooltip-icon-des">
                          <span class="tooltiptext-icon-des">Pagos pendientes</span>
                          <span class="icono_operario_accion  fa fa-briefcase" onclick="mostrarIntervencionesTecnico('${resource.idTecnico}')"  ></span>
                      </div>
                  </div> 
              </div>
          </div>
