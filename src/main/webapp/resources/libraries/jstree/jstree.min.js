        ...
        c.setAttribute("role", "treeitem"), l = o.createElement("I"), l.className = "jstree-icon jstree-ocl", l.setAttribute("role", "presentation"), c.appendChild(l), l = o.createElement("A"), l.className = "jstree-anchor", l.setAttribute("href", "#"), l.setAttribute("tabindex", "-1"), h = o.createElement("I"), h.className = "jstree-icon jstree-themeicon", h.setAttribute("role", "presentation"), l.appendChild(h), c.appendChild(l), l = h = null, e.jstree = {
            ...
            bind: function() {
                this.element.on("dblclick.jstree", function() {
                    ...
                    if (i.status && ("#" !== i.node.id || this._data.core.loaded || (this._data.core.loaded = !0, this.element.attr("aria-activedescendant", this._firstChild(this.get_container_ul()[0]).id), this.trigger("loaded")), !this._data.core.ready && !this.get_container_ul().find(".jstree-loading").length)) {
            ...
            load_node: function(t, i) {
                ...
                return t.state.loading = !0, this.get_node(t, !0).addClass("jstree-loading").attr("aria-busy", !0), this._load_node(t, e.proxy(function(e) {
                    ...
                    t.state.loaded && !t.children.length && r && r.length && !r.hasClass("jstree-leaf") && r.removeClass("jstree-closed jstree-open").addClass("jstree-leaf"), r.removeClass("jstree-loading").attr("aria-busy", !1), this.trigger("load_node", {
                        node: t,
                        status: e
                    }), i && i.call(this, t, e)
                }, this)), !0
                    ...
                    d = function(e, t) {
                        ...
                        var i = e.dat,
                            ...
                            u, g, f, p, m = function(e, i, r) {
                                ...
                                for (e && e.children && e.children === !0 && (_.state.loaded = !1, _.children = [], _.children_d = []), l[_.id] = _, n = 0, o = _.children.length; o > n; n++) c = m(l[_.children[n]], _.id, r), h = l[c], _.children_d.push(c), h.children_d.length && (_.children_d = _.children_d.concat(h.children_d));
                            ...
                            v = function(e, i, r) {
                                ...
                                if (e && e.children && e.children.length) {
                                    for (n = 0, h = e.children.length; h > n; n++) _ = v(e.children[n], g.id, r), u = l[_], g.children.push(_), u.children_d.length && (g.children_d = g.children_d.concat(u.children_d));
                        ...
                        if (i.length && i[0].id !== t && i[0].parent !== t) {
                            ...
                            for (g = 0, f = h.children.length; f > g; g++) u = m(l[h.children[g]], r, h.parents.concat()), n.push(u), l[u].children_d.length && (n = n.concat(l[u].children_d));
                            ...
                            for (g = 0, f = i.length; f > g; g++) u = v(i[g], r, h.parents.concat()), u && (s.push(u), n.push(u), l[u].children_d.length && (n = n.concat(l[u].children_d)));
            ...
            _parse_model_from_flat_json: function(e, i, r) {
                ...
                for (e && e.children && e.children === !0 && (h.state.loaded = !1, h.children = [], h.children_d = []), n[h.id] = h, d = 0, o = h.children.length; o > d; d++) c = this._parse_model_from_flat_json(n[h.children[d]], h.id, r), l = n[c], h.children_d.push(c), l.children_d.length && (h.children_d = h.children_d.concat(l.children_d));
            ...
            _parse_model_from_json: function(e, i, r) {
                ...
                var s = !1,
                    ...
                    h;
                do s = "j" + this._id + "_" + ++this._cnt; while (c[s]);
                h = {
                    id: !1,
                    text: "string" == typeof e ? e : "",
                    icon: "object" == typeof e && e.icon !== t ? e.icon : !0,
                ...
                if (e && e.children && e.children.length) {
                    for (n = 0, a = e.children.length; a > n; n++) d = this._parse_model_from_json(e.children[n], h.id, r), o = c[d], h.children.push(d), o.children_d.length && (h.children_d = h.children_d.concat(o.children_d));
            ...
            _redraw: function() {
                var e = this._model.force_full_redraw ? this._model.data["#"].children.concat([]) : this._model.changed.concat([]),
                    ...
                    i, r, s, n = this._data.core.focused;
                for (r = 0, s = e.length; s > r; r++) i = this.redraw_node(e[r], !0, this._model.force_full_redraw), i && this._model.force_full_redraw && t.appendChild(i);
            ...
            open_node: function(i, r, s) {
                ...
                if (s = s === t ? this.settings.core.animation : s, !this.is_closed(i)) return r && r.call(this, i, !1), !1;
                if (this.is_loaded(i)) d = this.get_node(i, !0), o = this, d.length && (i.children.length && !this._firstChild(d.children(".jstree-children")[0]) && (this.redraw_node(i, !0, !1, !0), d = this.get_node(i, !0)), s ? (this.trigger("before_open", {
                    node: i
                    ...
                    node: i
                }), d[0].className = d[0].className.replace("jstree-closed", "jstree-open"), d[0].setAttribute("aria-expanded", !0))), i.state.opened = !0, r && r.call(this, i, !0), d.length || this.trigger("before_open", {
                    node: i
            ...
            enable_node: function(i) {
                ...
                return i = this.get_node(i), i && "#" !== i.id ? (i.state.disabled = !1, this.get_node(i, !0).children(".jstree-anchor").removeClass("jstree-disabled").attr("aria-disabled", !1), this.trigger("enable_node", {
                    node: i
                }), t) : !1
            },
            disable_node: function(i) {
                ...
                return i = this.get_node(i), i && "#" !== i.id ? (i.state.disabled = !0, this.get_node(i, !0).children(".jstree-anchor").addClass("jstree-disabled").attr("aria-disabled", !0), this.trigger("disable_node", {
                    node: i
                }), t) : !1
            },
                ...
                if (this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && (!i.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent))
                    if (i.shiftKey) {
                        var r = this.get_node(e).id,
                            ...
                            a = !1,
                            d, o;
                        for (d = 0, o = n.length; o > d; d += 1) n[d] === r && (a = !a), n[d] === s && (a = !a), a || n[d] === r || n[d] === s ? this.select_node(n[d], !0, !1, i) : this.deselect_node(n[d], !0, i);
                        this.trigger("changed", {
                            action: "select_node",
            ...
            dehover_node: function(e) {
                return e = this.get_node(e, !0), e && e.length && e.children(".jstree-hovered").length ? (e.children(".jstree-anchor").removeClass("jstree-hovered"), this.trigger("dehover_node", {
                    node: this.get_node(e)
                }), t) : !1
            },
            select_node: function(i, r, s, n) {
                ...
                return i = this.get_node(i), i && "#" !== i.id ? (a = this.get_node(i, !0), i.state.selected || (i.state.selected = !0, this._data.core.selected.push(i.id), s || (a = this._open_to(i)), a && a.length && a.attr("aria-selected", !0).children(".jstree-anchor").addClass("jstree-clicked"), this.trigger("select_node", {
                    node: i,
                    selected: this._data.core.selected,
                    event: n
            ...
            deselect_node: function(i, r, s) {
                ...
                return i = this.get_node(i), i && "#" !== i.id ? (d = this.get_node(i, !0), i.state.selected && (i.state.selected = !1, this._data.core.selected = e.vakata.array_remove_item(this._data.core.selected, i.id), d.length && d.attr("aria-selected", !1).children(".jstree-anchor").removeClass("jstree-clicked"), this.trigger("deselect_node", {
                    node: i,
                    selected: this._data.core.selected,
                    event: s
                }), r || this.trigger("changed", {
            ...
            get_top_selected: function(t) {
                ...
                for (s = 0, n = i.length; n > s; s++)
                    for (a = 0, d = i[s].children_d.length; d > a; a++) r[i[s].children_d[a]] && delete r[i[s].children_d[a]];
                i = [];
            ...
            set_state: function(i, r) {
                if (i) {
                    if (i.core) {
                        var s, n, a, d;
                        if (i.core.open) return e.isArray(i.core.open) ? (s = !0, n = !1, a = this, e.each(i.core.open.concat([]), function(t, d) {
            ...
            refresh: function(t, i) {
                ...
                t || (this.element.html("<ul class='" + r + "' role='group'><" + "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem' id='j" + this._id + "_loading'><i class='jstree-icon jstree-ocl'></i><" + "a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("Loading ...") + "</a></li></ul>"), this.element.attr("aria-activedescendant", "j" + this._id + "_loading")), this.load_node("#", function(t, i) {
                    i && (this.get_container_ul()[0].className = r, this.element.attr("aria-activedescendant", this._firstChild(this.get_container_ul()[0]).id), this.set_state(e.extend(!0, {}, this._data.core.state), function() {
            ...
            get_json: function(t, i, r) {
                ...
                if (i && i.flat ? s.parent = t.parent : s.children = [], !i || !i.no_state)
                    for (n in t.state) t.state.hasOwnProperty(n) && (s.state[n] = t.state[n]);
                if (i && i.no_id && (delete s.id, s.li_attr && s.li_attr.id && delete s.li_attr.id), i && i.flat && "#" !== t.id && r.push(s), !i || !i.no_children)
                    for (n = 0, a = t.children.length; a > n; n++) i && i.flat ? this.get_json(t.children[n], i, r) : s.children.push(this.get_json(t.children[n], i));
                return i && i.flat ? r : "#" === t.id ? s.children : s
            },
            create_node: function(i, r, s, n, a) {
                if (null === i && (i = "#"), i = this.get_node(i), !i) return !1;
                if (s = s === t ? "last" : s, !("" + s).match(/^(before|after)$/) && !a && !this.is_loaded(i)) return this.load_node(i, function() {
                ...
                return d[s] = r.id, i.children = d, this.redraw_node(i, !0), n && n.call(this, this.get_node(r)), this.trigger("create_node", {
            ...
            rename_node: function(t, i) {
                ...
                addReanameNode(this.get_node(t));
            ...
            move_node: function(i, r, s, n, a, d) {
                var o, c, l, h, _, u, g, f, p, m, v, j, k, y;
                if (r = this.get_node(r), s = s === t ? 0 : s, !r) return !1;
                if (!("" + s).match(/^(before|after)$/) && !a && !this.is_loaded(r)) return this.load_node(r, function() {
                ...
                if (i.parent === _.id) {
                    ...
                    for (p = i.children_d.concat(), p.push(i.id), m = 0, v = i.parents.length; v > m; m++) {
                        for (f = [], y = u._model.data[i.parents[m]].children_d, j = 0, k = y.length; k > j; j++) - 1 === e.inArray(y[j], p) && f.push(y[j]);
                ...
                return n && n.call(this, i, _, s), this.trigger("move_node", {
                    node: i,
                    parent: _.id,
                    position: s,
                    old_parent: l,
            ...
            copy_node: function(i, r, s, n, a, d) {
                ...
                if (e.isArray(i)) {
                    for (i = i.slice(), o = 0, c = i.length; c > o; o++) h = this.copy_node(i[o], r, s, n, a, !0), h && (r = h, s = "after");
                    return this.redraw(), !0
                }
                if (i = i && i.id ? i : this.get_node(i), !i || "#" === i.id) return !1;
                ...
                return l[s] = h.id, p.children = l, p.children_d.push(h.id), p.children_d = p.children_d.concat(h.children_d), "#" === p.id && (this._model.force_full_redraw = !0), this._model.force_full_redraw || this._node_changed(p.id), d || this.redraw("#" === p.id), n && n.call(this, h, p, s), this.trigger("copy_node", {
                    node: h,
                    original: i,
                    parent: p.id,
                    position: s,
            ...
            paste: function(e, i) {
                return e = this.get_node(e), e && s && s.match(/^(copy_node|move_node)$/) && r ? (this[s](r, e, i) && this.trigger("paste", {
                    parent: e.id,
                    node: r,
                    mode: s
                }), r = !1, s = !1, n = !1, t) : !1
                ...
                this.bind = function() {
                    r.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", e.proxy(function() {
                        ...
                        var i = this._model.data,
                            ...
                            s = t.nodes,
                            n, a;
                        for (n = 0, a = s.length; a > n; n++) i[s[n]].state.checked = i[s[n]].original && i[s[n]].original.state && i[s[n]].original.state.checked, i[s[n]].state.checked && this._data.checkbox.selected.push(s[n])
                        ...
                        if (-1 !== h.indexOf("down"))
                            for (this._data[_ ? "core" : "checkbox"].selected = e.vakata.array_unique(this._data[_ ? "core" : "checkbox"].selected.concat(r.children_d)), d = 0, o = r.children_d.length; o > d; d++) l = s[r.children_d[d]], l.state[_ ? "selected" : "checked"] = !0, l && l.original && l.original.state && l.original.state.undetermined && (l.original.state.undetermined = !1);
                        if (-1 !== h.indexOf("up"))
                            while (n && "#" !== n.id) {
                        ...
                        var i = this.get_node("#"),
                            r = this._model.data,
                            s, n, a;
                        for (s = 0, n = i.children_d.length; n > s; s++) a = r[i.children_d[s]], a && a.original && a.original.state && a.original.state.undetermined && (a.original.state.undetermined = !1)
                        ...
                        if (r && r.original && r.original.state && r.original.state.undetermined && (r.original.state.undetermined = !1), -1 !== o.indexOf("down"))
                            for (n = 0, a = r.children_d.length; a > n; n++) d = this._model.data[r.children_d[n]], d.state[c ? "selected" : "checked"] = !1, d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1);
                        if (-1 !== o.indexOf("up"))
                            for (n = 0, a = r.parents.length; a > n; n++) d = this._model.data[r.parents[n]], d.state[c ? "selected" : "checked"] = !1, d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1), d = this.get_node(r.parents[n], !0), d && d.length && d.attr("aria-selected", !1).children(".jstree-anchor").removeClass(c ? "jstree-clicked" : "jstree-checked");
                        ...
                        var i = this.get_node(t.parent),
                            r = this._model.data,
                            s, n, a, d, o = this.settings.checkbox.tie_selection;
                        while (i && "#" !== i.id) {
                    ...
                    for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function() {
                            var e = d.get_node(this),
                                s;
                            if (e.state.loaded)
                                for (t = 0, i = e.children_d.length; i > t; t++) s = r[e.children_d[t]], !s.state.loaded && s.original && s.original.state && s.original.state.undetermined && s.original.state.undetermined === !0 && (a.push(s.id), a = a.concat(s.parents));
                    ...
                    for (r = 0, s = t.children_d.length; s > r; r++)
                        if (-1 !== e.inArray(t.children_d[r], a) || !d[t.children_d[r]].state.loaded && d[t.children_d[r]].original.state.undetermined) return !0;
                    return !1
                }, this.activate_node = function(i, s) {
                    return this.settings.checkbox.tie_selection && (this.settings.checkbox.whole_node || e(s.target).hasClass("jstree-checkbox")) && (s.ctrlKey = !0), this.settings.checkbox.tie_selection || !this.settings.checkbox.whole_node && !e(s.target).hasClass("jstree-checkbox") ? r.activate_node.call(this, i, s) : (this.is_checked(i) ? this.uncheck_node(i, s) : this.check_node(i, s), this.trigger("activate_node", {
                        node: this.get_node(i)
                    }), t)
                    ...
                    return i = this.get_node(i), i && "#" !== i.id ? (s = this.get_node(i, !0), i.state.checked || (i.state.checked = !0, this._data.checkbox.selected.push(i.id), s && s.length && s.children(".jstree-anchor").addClass("jstree-checked"), this.trigger("check_node", {
                        node: i,
                        ...
                        if (o && o._data && o._data.dnd)
                            if (n.attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")), d.helper.children().attr("class", "jstree-" + o.get_theme() + " jstree-" + o.get_theme() + "-" + o.get_theme_variant() + " " + (o.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")).find(".jstree-copy").first()[d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "show" : "hide"](), d.event.target !== o.element[0] && d.event.target !== o.get_container_ul()[0] || 0 !== o.get_container_ul().children().length) {
                                if (c = e(d.event.target).closest(".jstree-anchor"), c && c.length && c.parent().is(".jstree-closed, .jstree-open, .jstree-leaf") && (l = c.offset(), h = d.event.pageY - l.top, g = c.height(), m = g / 3 > h ? ["b", "i", "a"] : h > g - g / 3 ? ["a", "i", "b"] : h > g / 2 ? ["i", "a", "b"] : ["i", "b", "a"], e.each(m, function(a, h) {
                                        ...
                                        for (v = !0, j = 0, k = d.data.nodes.length; k > j; j++)
                                        ...
                                        }(o, c), o.settings.dnd.open_timeout)), v ? (i = {
                                            ins: o,
                                            par: f,
                                            ...
                                            left: _ + "px",
                                            top: u + "px"
                                        }).show(), d.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"), r = {}, m = !0, !1) : t
                                    }), m === !0)) return
                            } else {
                                for (v = !0, j = 0, k = d.data.nodes.length; k > j; j++)
                                ...
                                if (v) return i = {
                                    ...
                                    par: "#",
                                    pos: "last"
                                }, n.hide(), d.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"), t
            ...
            function(e) {
                ...
                e.vakata.dnd = {
                    ...
                    start: function(t, r, s) {
                        ...
                        return i.init_x = t.pageX, i.init_y = t.pageY, i.data = r, i.is_down = !0, i.element = t.currentTarget, i.target = t.target, i.is_touch = "touchstart" === t.type, s !== !1 && (i.helper = e("<div id='vakata-dnd'></div>").html(s).css({
                            display: "block",
                            margin: "0",
                            padding: "0",
                            position: "absolute",
                ...
                this.bind = function() {
                    ...
                    var n = this.settings.search,
                        ...
                        c = [],
                        l, h;
                    return this._data.search.res.length && this.clear_search(), s === t && (s = n.show_only_matches), r || a === !1 ? (this._data.search.str = i, this._data.search.dom = e(), this._data.search.res = [], this._data.search.opn = [], this._data.search.som = s, d = new e.vakata.search(i, !0, {
                ...
                e.vakata.search = function(e, t, i) {
                    ...
                    return a > 32 && (i.fuzzy = !1), i.fuzzy && (d = 1 << a - 1, o = function() {
                        ...
                        for (-1 !== u && (_ = Math.min(c(0, u), _), u = t.lastIndexOf(e, r + a), -1 !== u && (_ = Math.min(c(0, u), _))), u = -1, s = 0; a > s; s++) {
                            g = 0, f = p;
                            while (f > g) _ >= c(s, r + f) ? g = f : p = f, f = Math.floor((p - g) / 2 + g);
                            for (p = f, v = Math.max(1, r - f + 1), j = Math.min(r + f, h) + a, k = Array(j + 2), k[j + 1] = (1 << s) - 1, l = j; l >= v; l--)
                                if (y = o[t.charAt(l - 1)], k[l] = 0 === s ? (1 | k[l + 1] << 1) & y : (1 | k[l + 1] << 1) & y | (1 | (m[l + 1] | m[l]) << 1) | m[l + 1], k[l] & d && (x = c(s, l - 1), _ >= x)) {
            ...
            function(e, t) {
                ...
                this.init = function(e, i) {
                    ...
                    if (i && i.types && i.types["default"])
                        for (s in i.types)
                            if ("default" !== s && "#" !== s && i.types.hasOwnProperty(s))
                                for (n in i.types["default"]) i.types["default"].hasOwnProperty(n) && i.types[s][n] === t && (i.types[s][n] = i.types["default"][n]);
                    ...
                    this.element.on("model.jstree", e.proxy(function(e, i) {
                        var r = this._model.data,
                            ...
                            a, d, o = "default";
                        for (a = 0, d = s.length; d > a; a++) o = "default", r[s[a]].original && r[s[a]].original.type && n[r[s[a]].original.type] && (o = r[s[a]].original.type), r[s[a]].data && r[s[a]].data.jstree && r[s[a]].data.jstree.type && n[r[s[a]].data.jstree.type] && (o = r[s[a]].data.jstree.type), r[s[a]].type = o, r[s[a]].icon === !0 && n[o].icon !== t && (r[s[a]].icon = n[o].icon);
                        r["#"].type = "#"
                    ...
                    return s = this.settings.types, i = this.get_node(i), s[r] && i ? (d = i.type, o = this.get_icon(i), i.type = r, (o === !0 || s[d] && s[d].icon && o === s[d].icon) && this.set_icon(i, s[r].icon !== t ? s[r].icon : !0), !0) : !1
                }
                ...
                this.check = function(t, i, s, n, a) {
                    ...
                    switch (c || (d = d.toLowerCase()), t) {
                        ...
                        case "move_node":
                            return h = i.parent === s.id || -1 === e.inArray(d, o), h || (this._data.core.last_error = {
                                error: "check",
                                plugin: "unique",
                                id: "unique_03",
                                reason: "Child with name " + d + " already exists. Preventing: " + t,
        ...
        g.setAttribute("unselectable", "on"), g.setAttribute("role", "presentation"), g.className = "jstree-wholerow", g.innerHTML = "&#160;", e.jstree.plugins.wholerow = function(t, i) {
                this.bind = function() {
                    i.bind.call(this), this.element.on("ready.jstree set_state.jstree", e.proxy(function() {
                        ...
                        var i = !1,
                            r, s;
                        for (r = 0, s = t.selected.length; s > r; r++) i = this.get_node(t.selected[r], !0), i && i.length && i.children(".jstree-wholerow").addClass("jstree-wholerow-clicked")
                    ...
                    if (t = i.redraw_node.apply(this, arguments)) {
                        var a = g.cloneNode(!0); - 1 !== e.inArray(t.id, this._data.core.selected) && (a.className += " jstree-wholerow-clicked"), t.insertBefore(a, t.childNodes[0])
                    }
                    return t
                }
            },
