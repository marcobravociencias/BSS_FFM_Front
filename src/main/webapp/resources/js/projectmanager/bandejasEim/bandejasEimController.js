...
app.controller('coordInstPIController', ['$scope', '$q', 'coordInstalacionesPIService', 'genericService', function ($scope, $q, coordInstalacionesPIService, genericService) {
	...
	$scope.consultarPendientes = function () {
		...
		$scope.resultPendientes = [];
		$scope.objetoBusqueda.pendiente = [];
		...
		if (bandera) {
			...
			tableAsignada = $("#tableAsignada").DataTable({
				...
				"ajax": {
					...
					"dataSrc": function (json) {
						if (json.result) {
							$scope.objetoBusqueda.asignada = json.result.ordenes ? json.result.ordenes : []
						}
						//$scope.elementosRegistro = json.registrosTotales
		...
		if (bandera) {
			...
			tableDetenida = $("#tableDetenida").DataTable({
				...
				"ajax": {
					...
					"dataSrc": function (json) {
						if (json.result) {
							$scope.objetoBusqueda.detenida = json.result.ordenes ? json.result.ordenes : []
						}
						//$scope.elementosRegistro = json.registrosTotales
	...
	$scope.consultarTerminada = function () {
		...
		$scope.estadoSelect = [];
		$scope.geografiaSelect = [];
		$scope.objetoBusqueda.terminada = [];
		...
		if (bandera) {
			...
			tableTerminada = $("#tableTerminada").DataTable({
				...
				"ajax": {
					...
					"dataSrc": function (json) {
						if (json.result) {
							$scope.objetoBusqueda.terminada = json.result.ordenes ? json.result.ordenes : []
						}
						//$scope.elementosRegistro = json.registrosTotales
	...
	$scope.consultarCancelada = function () {
		...
		$scope.estadoSelect = [];
		$scope.geografiaSelect = [];
		$scope.objetoBusqueda.cancelada = [];
		...
		if (bandera) {
			...
			tableCancelada = $("#tableCancelada").DataTable({
				...
				"ajax": {
					...
					"dataSrc": function (json) {
						if (json.result) {
							$scope.objetoBusqueda.cancelada = json.result.ordenes ? json.result.ordenes : []
						}
						//$scope.elementosRegistro = json.registrosTotales
	...
	$scope.consultarCalendarizada = function () {
		...
		$scope.geografiaSelect = [];
		$scope.resultCalendarizada = [];
		$scope.objetoBusqueda.calendarizada = [];
		...
		if (bandera) {
			...
			tableCalendarizada = $("#tableCalendarizada").DataTable({
				...
				"ajax": {
					...
					"dataSrc": function (json) {
						if (json.result) {
							$scope.objetoBusqueda.calendarizada = json.result.ordenes ? json.result.ordenes : []
		...
		if (bandera) {
			...
			tableGestoria = $("#tableGestoria").DataTable({
				...
				"ajax": {
					...
					"dataSrc": function (json) {
						if (json.result) {
							$scope.objetoBusqueda.gestoria = json.result.ordenes ? json.result.ordenes : []
