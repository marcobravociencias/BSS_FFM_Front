...
<div class="modal fade" tabindex="-1" style="z-index: 1062 !important;" aria-labelledby="exampleModalLabel" aria-hidden="true" id="modal-jerarquia-filtro">
	<div class="modal-dialog">
	  <div class="modal-content">
		...
		<div class="modal-body" style=" max-height: 300px; overflow: auto;">
		  ...
		  <div id="jstree-proton-3" class="proton-demo mt-2"></div>
		</div>
