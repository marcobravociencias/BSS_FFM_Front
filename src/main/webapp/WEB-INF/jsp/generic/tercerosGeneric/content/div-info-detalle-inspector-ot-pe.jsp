					...
					<div class="col-md-12">
						<div class="container-fluid terceros-content">
							...
							<div class="container-text-content-detalle">
								<span class="text-content-terceros" title="{{infoDetalleOtPe.detalleInspeccion.fechaReporte}}" 
				...
				<div class="row">
					<div class="col-md-12">
						<div class="container-fluid terceros-content">
							...
							<div class="container-text-content-detalle">
								<span class="text-content-terceros" title="{{infoDetalleOtPe.detalleInspeccion.nombreEmpleadoReporta}}" 
				...
				<div class="row">
					<div class="col-md-12">
						<div class="container-fluid terceros-content">
							...
							<div class="container-text-content-detalle">
								<span class="text-content-terceros" title="{{falla.descripcionFalla}}" ng-bind="falla.descripcionFalla || 'Sin dato'"></span>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="container-fluid terceros-content">
							...
							<div class="container-text-content-detalle">
								<span class="text-content-terceros" title="{{falla.descripcionDetalleFalla}}" ng-bind="falla.descripcionDetalleFalla || 'Sin dato'"></span>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="container-fluid terceros-content">
							...
							<div class="container-text-content-detalle">
								<span class="text-content-terceros" title="{{falla.comentarios}}" ng-bind="falla.comentarios || 'Sin dato'"></span>
							</div>
						</div>
					</div>
				</div>
