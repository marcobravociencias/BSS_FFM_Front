		...
		<div class="container" id="container_terceros_generic">
			...
			<div class="col-md-12 row contenedoresFila">
				...
				<div class="col-md-8 p-0 pt-4">
					...
					<div ng-show="mostrarNavAccionesDetalleOtPendiente" class="col-md-12 containerInformacionDetalleOt p-0">
							...
							<div class="row">
								...
								<div class="col-10">
									<div class="tab-content" id="v-tabs-tabsContent">
										<div class="tab-pane fade show active" id="v-tabs-consulta-detalleot" role="tabpanel"
											...
											<div class="row">
												<div class="col-6">
													<div class="container-fluid terceros-content">
														...
														<div class="container-text-content-detalle"><span
																class="text-content-terceros" title="{{infoOtDetalle.idOrden}}"
													...
													<div class="container-fluid terceros-content">
														...
														<div class="container-text-content-detalle"><span
																class="text-content-terceros" title="{{infoOtDetalle.folioSistema}}"
													...
													<div class="container-fluid terceros-content">
														...
														<div class="container-text-content-detalle"><span
																...
																ng-bind="infoOtDetalle.fechaHoraProgramada || 'Sin dato'"></span> </div>
													</div>
													<div class="container-fluid terceros-content">
														<div class="container-text-title-detalle"><span
																class="text-tile-terceros">Estatus</span></div>
														<div class="container-text-content-detalle"><span
																class="text-content-terceros" title="{{infoOtDetalle.Status}}"
													...
													<div class="container-fluid terceros-content">
														...
														<div class="container-text-content-detalle"><span
																class="text-content-terceros" title="{{infoOtDetalle.Estado}}"
													...
													<div class="container-fluid terceros-content">
														...
														<div class="container-text-content-detalle"><span
																class="text-content-terceros" title="{{infoOtDetalle.Motivo}}"
													...
													<div class="container-fluid terceros-content">
														<div class="container-text-title-detalle"><span
																class="text-tile-terceros">Carta aceptaci&oacute;n</span></div>
														<div class="container-text-content-detalle">
															<span class="text-content-terceros" ng-show="!infoOtDetalle.acta" ng-bind="'No se encontr&oacute; carta de aceptaci&oacute;n'"></span>
												...
												<div class="col-6">
													...
													<div class="container-fluid terceros-content">
														<div class="container-text-title-detalle"><span
																class="text-tile-terceros">C&oacute;digo postal</span></div>
														<div class="container-text-content-detalle"><span
																class="text-content-terceros"
												...
												<div class="col-12">
													...
													<div class="row justify-content-center">
														<div class="col-md-6">
															<div class="container-fluid terceros-content">
																<div class="container-text-title-detalle"><span
																		class="text-tile-terceros">Cuenta factura</span></div>
																<div class="container-text-content-detalle"><span
																		class="text-content-terceros"
													...
													<div class="row justify-content-center">
														<div class="col-md-6">
															<div class="container-fluid terceros-content">
																<div class="container-text-title-detalle"><span
																		class="text-tile-terceros">Folio CSP</span></div>
																<div class="container-text-content-detalle"><span
																		class="text-content-terceros"
														...
														<div class="col-md-6">
															<div class="container-fluid terceros-content">
																<div class="container-text-title-detalle"><span
																		class="text-tile-terceros">Folio Sitio</span></div>
																<div class="container-text-content-detalle"><span
																		class="text-content-terceros"
													...
													<div class="row justify-content-center">
														<div class="col-md-6">
															<div class="container-fluid terceros-content">
																<div class="container-text-title-detalle"><span
																		class="text-tile-terceros">Monto primer pago</span>
																</div>
																<div class="container-text-content-detalle"><span
																		class="text-content-terceros"
										...
										<div ng-show="infoOtDetalle.idEstado =='206' || infoOtDetalle.idEstado ==206"  class="tab-pane fade"
