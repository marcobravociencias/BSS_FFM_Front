...
<!-- Modal -->
<div class="modal fade" tabindex="-1" style="z-index: 1062 !important;" aria-labelledby="exampleModalLabel" aria-hidden="true" id="modal-geografia-creacion">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style=" max-height: 300px; overflow: auto;">
          <div class="input-group input-group-sm content-seach-group">
           ...
           <div id="jstre-content-geofrafia" class="jstre-content-geofrafia proton-demo"></div>
        </div>
