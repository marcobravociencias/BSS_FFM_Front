<div ng-show="vistaAgendamiento">
    <div class="row mt-2">
        <div class="col-10">
            <span class="" style="font-weight: bold;">Cliente: {{elementoCSP.cuentaFacturaSf.nombreCuentaFactura}}</span>
        </div>
        <div class="col-2 pr-0">
            <button id="cerrarAgendamiento" ng-click="cerrarAgendamiento()" type="button" class="btn-close" style="float: right; padding: 0.5em;"></button>
        </div>
