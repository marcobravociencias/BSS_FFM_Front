<div class="container-fluid container-tab">
    <div class="container-filtros">
        <div class="row md-form" id="filtros_config">
            ...
            <div class="col-md-2 columna-filtro-indR pl-0">
                ...
                <select class="input-filtro form-control form-control-sm" id="tipo_reporte_empresarial"
                    style="border: 1px solid #dbdbdb !important; background: white !important;" ng-model="reporte.empresarial" ng-change="changeCalendar(this, 'empresarial')">
            ...
            <div class="col-md-2 columna-filtro-indR pl-0">
                ...
                <input readonly placeholder="Fecha" type="text" id="filtro_fecha_dia_empresarial" style="display: block;"
                    class="datepicker input-filtro form-control form-control-sm" />
                <input readonly placeholder="Fecha" type="text" id="filtro_fecha_semana_empresarial" style="display: none;"
                    class="datepicker input-filtro form-control form-control-sm" />
                <input readonly placeholder="Fecha" type="text" id="filtro_fecha_mes_empresarial" style="display: none;"
                    class="datepicker input-filtro form-control form-control-sm" />
            </div>
    ...
    <div class="content-fluid mt-2">
        <div class="table-responsive">
            <table id="reporteEmpresarialTable" class="display table" cellspacing="0" width="100%">
