    ...
    <div class="container-filtros">
        <div class="row md-form" id="filtros_config">
            <div class="col-md-2 columna-filtro-indRR">
                ...
                <input readonly placeholder="GEOGRAF&Iacute;A" type="text" id="cluster-ventasemp"
                    class="input-filtro form-control form-control-sm" ng-click="abrirModalGeografiaRep('ventasemp')" />
            </div>
            <div class="col-md-2 columna-filtro-indR pl-0">
                <label class="label-filter">Tipo fecha</label>
                <select class="input-filtro form-control form-control-sm" id="tipo_reporte_ventasemp"
                    style="border: 1px solid #dbdbdb !important; background: white !important;" ng-model="reporte.ventasemp" ng-change="changeCalendar(this, 'ventasemp')">
            ...
            <div class="col-1 div-btn-busqueda pl-0">
                <button id="btn_consultar" type="button"
                    ...
                    ng-click="consultarReporteVentasEmpresarial()">
                    <i class="fa fa-search"></i>
                </button>
            </div>
            <div class="col-1 download-file" ng-if="configPermisoAccionDescargaIngresosVentasEmp">
                <img alt="excel" src="${pageContext.request.contextPath}/resources/img/generic/group-10.png"
                    style="cursor:pointer; margin-top: 1.5em;" ng-click="descargarReporteVentasEmpresarial()">
            </div>
        </div>
    </div>
    <div class="content-fluid mt-2">
        <div class="table-responsive">
            <table id="reporteVentasEmpTable" class="display table  table-reportesf" cellspacing="0" width="100%">
                <thead id="thead_reporteVentasEmp">
                    <tr>
                        ...
                        <th data-idColumn="4" data-isNumber="false" class="orderColumnTable orderColumnAscTable">Fecha agendamiento
                        </th>
                        ...
                        <th data-idColumn="7" data-isNumber="false" class="orderColumnTable orderColumnAscTable">Ganada</th>
