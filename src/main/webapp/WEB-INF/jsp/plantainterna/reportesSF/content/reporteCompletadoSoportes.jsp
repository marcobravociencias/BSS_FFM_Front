    ...
    <div class="container-filtros">
        <div class="row md-form" id="filtros_config">
            <div class="col-md-2 columna-filtro-indRR">
                ...
                <input readonly placeholder="GEOGRAF&Iacute;A" type="text" id="cluster-soportescomp"
                    class="input-filtro form-control form-control-sm" ng-click="abrirModalGeografiaRep('soportescomp')" />
            </div>
            <div class="col-md-2 columna-filtro-indR pl-0">
                <label class="label-filter">Tipo fecha</label>
                <select class="input-filtro form-control form-control-sm" id="tipo_reporte_soportescomp"
                    style="border: 1px solid #dbdbdb !important; background: white !important;" ng-model="reporte.soportescomp" ng-change="changeCalendar(this, 'soportescomp')">
            ...
            <div class="col-1 div-btn-busqueda pl-0">
                <button id="btn_consultar" type="button"
                    ...
                    ng-click="consultarReporteSoportesCompletado()">
                    <i class="fa fa-search"></i>
                </button>
            </div>
            <div class="col-1 download-file" ng-if="configPermisoAccionDescargaCompletadoSoportes">
                <img alt="excel" src="${pageContext.request.contextPath}/resources/img/generic/group-10.png"
                    style="cursor:pointer; margin-top: 1.5em;" ng-click="descargarReporteSoportesCompletado()">
            </div>
        </div>
    </div>
    <div class="content-fluid mt-2">
        <div class="table-responsive">
            <table id="reporteSoportesCompTable" class="display table table-reportesf" cellspacing="0" width="100%">
                <thead id="thead_reporteSoportesComp">
                    <tr>
