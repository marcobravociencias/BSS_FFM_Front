    ...
    <div class="container-filtros">
        <div class="row md-form" id="filtros_config">
            <div class="col-md-2 columna-filtro-indR">
                ...
                <select class="input-filtro form-control form-control-sm" id="tipo_reporte_complecambdomic"
                    style="border: 1px solid #dbdbdb !important; background: white !important;" ng-model="reporte.complecambdomic" ng-change="changeCalendar(this, 'complecambdomic')">
            ...
            <div class="col-md-2 columna-filtro-indR pl-0">
                ...
                <input readonly placeholder="Fecha" type="text" id="filtro_fecha_dia_complecambdomic" style="display: block;"
                    class="datepicker input-filtro form-control form-control-sm" />
                <input readonly placeholder="Fecha" type="text" id="filtro_fecha_semana_complecambdomic" style="display: none;"
                    class="datepicker input-filtro form-control form-control-sm" />
            </div>
            <div class="col-1 div-btn-busqueda pl-0">
                <button id="btn_consultar" type="button"
                    ...
                    ng-click="consultarReporteCompletosCambioDomicilio()">
                    <i class="fa fa-search"></i>
                </button>
            </div>
            <div class="col-1 download-file" ng-if="configPermisoAccionDescargaCompletadoCambioDomicilio">
                <img alt="excel" src="${pageContext.request.contextPath}/resources/img/generic/group-10.png"
                    style="cursor:pointer; margin-top: 1.5em;" ng-click="descargarReporteCompletosCambioDomicilio()">
            </div>
        </div>
    </div>
