    ...
    <div class="container-filtros">
        <div class="row md-form" id="filtros_config">
            <div class="col-md-2 columna-filtro-indR">
                ...
                <select class="input-filtro form-control form-control-sm" id="tipo_reporte_factibilcerrados"
                    style="border: 1px solid #dbdbdb !important; background: white !important;" ng-model="reporte.factibilcerrados" ng-change="changeCalendar(this, 'factibilcerrados')">
            ...
            <div class="col-md-2 columna-filtro-indR pl-0">
                ...
                <input readonly placeholder="Fecha" type="text" id="filtro_fecha_dia_factibilcerrados" style="display: block;"
                    class="datepicker input-filtro form-control form-control-sm" />
                <input readonly placeholder="Fecha" type="text" id="filtro_fecha_semana_factibilcerrados" style="display: none;"
                    class="datepicker input-filtro form-control form-control-sm" />
            </div>
            <div class="col-1 div-btn-busqueda pl-0">
                <button id="btn_consultar" type="button"
                    ...
                    ng-click="consultarReporteFactibilidadCerrados()">
                    <i class="fa fa-search"></i>
                </button>
            </div>
            <div class="col-1 download-file" ng-if="configPermisoAccionDescargaFactibilidadCerrados">
                <img alt="excel" src="${pageContext.request.contextPath}/resources/img/generic/group-10.png"
                    style="cursor:pointer; margin-top: 1.5em;" ng-click="descargarReporteFactibilidadCerrados()">
            </div>
        </div>
    </div>
    <div class="content-fluid mt-2">
        <div class="table-responsive">
            <table id="reporteFactibilidadCerradosTable" class="display table  table-reportesf" cellspacing="0" width="100%">
                <thead id="thead_reporteFactibilidadCerrados">
                    <tr>
                        ...
                        <th data-idColumn="3" data-isNumber="true" class="orderColumnTable orderColumnAscTable">Estatus OT</th>
