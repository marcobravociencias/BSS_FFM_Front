<div class="container-fluid container-tab">
        ...
        <div class="row md-form" id="filtros_config">
            ...
            <div class="col-1 div-btn-busqueda pl-0">
                <button id="btn_consultar" type="button"
                    ...
                    ng-click="consultarReporteSoportes()">
    ...
    <div class="content-fluid mt-2">
        <div class="table-responsive">
            <table id="reporteSoportesTable" class="display table  table-reportesf" cellspacing="0" width="100%">
                <thead id="thead_reporteSoportes">
                    <tr>
