...
<html ng-app="bandejasSalesforceApp">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/resources/css/plantainterna/bandejasSalesforce/styleBandejasSalesforce.css?v=${sessionScope.versionDepl}"  rel="stylesheet"/>
