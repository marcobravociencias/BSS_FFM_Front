                    ...
                    <div class="row">
                        <div class="col-2  columna-filtro-ind-rep input-box" style="width: 100px !important;">
                            <label for="filtro-estatus-substatus" class="label-filter">
                                <i ng-if="filtrosGeneral && !filtrosGeneral.estatusConsultaTodos.length" class="icono-noseleccion fas fa-exclamation-circle ml-2" title="No se encontr&oacute;o el catalogo de estatus"></i>
                            </label>
                            <div class="dropdown">
                                <input readonly data-mdb-toggle="dropdown" aria-expanded="false" placeholder="Estatus" type="text" id="filtro-estatus-reporte" class="input-filtro-reporte form-control form-control-sm" />
                                <ul class="dropdown-menu drop-down-filters" aria-labelledby="filtro-estatus">      
                                    ...
                                    <li ng-repeat="filtro in filtrosGeneral.estatusConsultaTodos" class="element-menu-filter">
                        ...
                        <div class="col-2  columna-filtro-ind-rep input-box" style="width: 120px !important;">
                            <label for="filtro-intervencion" class="label-filter">
                                <i ng-if="banderaErrorIntervencion" class="icono-noseleccion fas fa-exclamation-circle ml-2" title="No se encontr&oacute;o el catalogo de intervenci&oacute;n"></i>
                            </label>
                            <div class="dropdown">
                                <input readonly data-mdb-toggle="dropdown" aria-expanded="false" placeholder="Intervenci&oacute;n" type="text" id="filtro-intervencion-reporte" class="input-filtro-reporte form-control form-control-sm" />
                        ...
                        <div class="col-1 input-box">
                            ...
                            <input type="text" id="idot-reporte" placeholder="Ej: 65434" ng-model="repDiario.idOrden" ng-change="limpiarCamposReporte(2)" autocomplete="off" class="form-control input-filtro-reporte form-control-sm">
                        </div>
                        <div class="col-1 input-box">
                            <label for="idos" class="label-filter">OS</label>
                            <input type="text" id="idos-reporte" placeholder="Ej: 23214" ng-model="repDiario.folio" ng-change="limpiarCamposReporte(1)" autocomplete="off" class="form-control input-filtro-reporte form-control-sm">
                        </div>
                        <div class="col-1 input-box">
                            <label for="cuenta" class="label-filter">Cuenta</label>
                            <input type="text" id="cuenta-reporte" placeholder="Ej: 0093484" ng-model="repDiario.idCuenta" ng-change="limpiarCamposReporte(3)" autocomplete="off" class="form-control input-filtro-reporte form-control-sm">
                        </div>
                        <div class="col-1 input-box">
                            ...
                            <input ng-click="abrirModalGeografia()" readonly placeholder="Geograf&iacute;a" type="text" id="filtro-geografia" class="form-control input-filtro-reporte form-control-sm" />
                        </div>
                        ...
                        <div class="col-1 columna-filtro-ind-rep input-box">
                            ...
                            <input readonly type="text" id="filtro_fecha_inicio_reporte" placeholder="Fecha inicial" ng-model="repDiario.fechaInicio" class="datepicker input-filtro-reporte form-control form-control-sm" />
                        </div>
                        <div class="col-1 columna-filtro-ind-rep input-box">
                            <label for="filtro_fecha_fin_reporte" class="label-filter">Fecha final</label>
                            <input readonly placeholder="Fecha Final" type="text" id="filtro_fecha_fin_reporte" ng-model="repDiario.fechaFin" class="datepicker input-filtro-reporte form-control form-control-sm" />
                        </div>
                        <div class="col-1">
                            <button type="button" class="btn btn-sm  btn-primary  waves-effect waves-light" onclick="consultarReporteDiario()" id="buscarReporte">
                                <i class="fa fa-search"></i>
                            </button>
                        </div>
                        <div class="col-1 download-file" ng-if="permisoDescargaSeguimientoDiario">
                            <img alt="excel" src="${pageContext.request.contextPath}/resources/img/generic/group-10.png" style="cursor:pointer" onclick="downloadExcelReportFile()">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 contenedor-table">
                            <div class="table-responsive" style="overflow-y: hidden; height: 105% !important;">
                                <table class="display table" cellspacing="0" width="100%" id="table-reporte">
                                    <thead id="head_table">
                                        <tr>
                                            ...
                                            <th data-idColumn="3" data-isNumber="false" class="orderColumnTable orderColumnAscTable">TIPO</th>
                                            <th data-idColumn="4" data-isNumber="false" class="orderColumnTable orderColumnAscTable">SUBTIPO</th>
                                            <th data-idColumn="5" data-isNumber="false" class="orderColumnTable orderColumnAscTable">ESTATUS</th>
                                            <th data-idColumn="6" data-isNumber="false" class="orderColumnTable orderColumnAscTable">ESTADO</th>
                                            <th data-idColumn="7" data-isNumber="false" class="orderColumnTable orderColumnAscTable">MOTIVO</th>
                                            <th data-idColumn="8" data-isNumber="false" class="orderColumnTable orderColumnAscTable">CIUDAD</th>
                                            <th data-idColumn="9" data-isNumber="false" class="orderColumnTable orderColumnAscTable">GEOGRAF&iacute;A</th>
                                            <th data-idColumn="10" data-isNumber="false" class="orderColumnTable orderColumnAscTable">#EMPLEADO</th>
                                            <th data-idColumn="11" data-isNumber="false" class="orderColumnTable orderColumnAscTable">#USUARIO</th>
                                            <th data-idColumn="12" data-isNumber="false" class="orderColumnTable orderColumnAscTable">T&Eacute;CNICO</th>
                                            <th data-idColumn="13" data-isNumber="false" class="orderColumnTable orderColumnAscTable">FECHA AGENDA</th>
                                            <th data-idColumn="14" data-isNumber="false" class="orderColumnTable orderColumnAscTable">FECHA FIN</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
