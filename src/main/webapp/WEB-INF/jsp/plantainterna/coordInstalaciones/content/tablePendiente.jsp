...
<div class="row md-form" id="">
    ...
    <div class="column-style-consulta columna-filtro-ind" style="width: 11%;">
        ...
        <div class="dropdown">
            <input id="estatusPendiente" readonly data-mdb-toggle="dropdown" aria-expanded="false" placeholder="Seleccione..." 
            ...
            <ul class="dropdown-menu drop-down-filters" aria-labelledby="filtro-intervencion">      
                <li style="text-align: center;">
                    <button ng-click="seleccionarTodosRecursivo(filtrosGeneral.estatusPendiente);pintarNombreEstatus(filtrosGeneral.estatusPendiente,'#estatusPendiente');" id="todo_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Todos</button>
                    <button ng-click="deseleccionarTodosRecursivo(filtrosGeneral.estatusPendiente);pintarNombreEstatus(filtrosGeneral.estatusPendiente,'#estatusPendiente');" id="ninguno_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Ninguno</button>
                </li>     
                ...
                <li ng-repeat="filtro in filtrosGeneral.estatusPendiente" class="element-menu-filter"  class="element-menu-filter">
                    <label  class="dropdown-item form-check-inputfiltro">
                        <input id="filtrotext-{{filtro.id}}" class="form-check-input" ng-click="setCheckFiltroGenericV2(filtro,filtrosGeneral.estatusPendiente);pintarNombreEstatus(filtrosGeneral.estatusPendiente,'#estatusPendiente');" type="checkbox" ng-model="filtro.checkedOpcion" ng-true-value="true" ng-false-value="false"/>
    ...
    <div class="column-style-consulta" id="fechaFin" style="width: 11%;">
        ...
        <input id="txtGeografiaPendiente" style="text-align: left;" readonly placeholder="Geografia" ng-click="mostrarArbol(1)" type="text" class="input-filtro-coordInst form-control form-control-sm">
    </div>
