    ...
    <div class="col-12 table-responsive" style="margin-top: 1em; padding: 0;">
        <table id="tableAsignada" class="table">
            <thead id="thead_asignada">
                <tr>
                    <th data-idColumn="0" data-isNumber="true" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">OT</th>
                    <th data-idColumn="1" data-isNumber="false" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">OS</th>
                    <th data-idColumn="2" data-isNumber="true" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">Cuenta</th>
                    ...
                    <th data-idColumn="4" data-isNumber="false" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">Fecha actualizaci&oacute;n</th>
                    <th data-idColumn="5" data-isNumber="false" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">Status</th>
                    <th data-idColumn="6" data-isNumber="false" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">Estado</th>
                    <th data-idColumn="7" data-isNumber="false" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">Motivo</th>
                    <th data-idColumn="8" data-isNumber="false" data-typeTable="reporteAsignada" class="orderColumnTable orderColumnAscTable">Actualizar Reg</th>
