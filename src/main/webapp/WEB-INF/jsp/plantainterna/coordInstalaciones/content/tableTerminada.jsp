    ...
    <div class="col-12 table-responsive" style="margin-top: 1em; padding: 0;">
        <table id="tableTerminada" class="table">
            <thead id="thead_terminada">
                <tr>
                    <th data-idColumn="0" data-isNumber="true" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">OT</th>
                    <th data-idColumn="1" data-isNumber="false" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">OS</th>
                    <th data-idColumn="2" data-isNumber="true" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">Cuenta</th>
                    <th data-idColumn="3" data-isNumber="false" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">Cliente</th>
                    <th data-idColumn="4" data-isNumber="false" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">Fecha actualizaci&oacute;n</th>
                    <th data-idColumn="5" data-isNumber="false" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">Status</th>
                    <th data-idColumn="6" data-isNumber="false" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">Estado</th>
                    <th data-idColumn="7" data-isNumber="false" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">Motivo</th>
                    <th data-idColumn="8" data-isNumber="false" data-typeTable="reporteTerminada" class="orderColumnTable orderColumnAscTable">Actualizar Reg</th>
