...
<div class="row md-form" id="">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu drop-down-filters" aria-labelledby="filtro-intervencion">      
                <li style="text-align: center;">
                    <button ng-click="seleccionarTodos(listaEstatusDetenida)" id="todo_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Todos</button>
                    <button ng-click="deseleccionarTodos(listaEstatusDetenida)" id="ninguno_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Ninguno</button>
                </li>     
                <li class="elemento_menu dropdown-divider"></li>
                <li ng-repeat="filtro in listaEstatusDetenida" class="element-menu-filter"  class="element-menu-filter">
    ...
    <div class="column-style-consulta columna-filtro-ind" style="width: 10%;">
        <label for="selectMotivoDetenida" class="label-filter">Estado</label>
        <div class="dropdown">
            <input readonly data-mdb-toggle="dropdown" aria-expanded="false" 
            placeholder="Seleccione..." type="text" id="selectMotivoDetenida" class="input-filtro-coordInst form-control form-control-sm" />
            <ul class="dropdown-menu drop-down-filters" aria-labelledby="filtro-estatus-substatus">      
                <li style="text-align: center;">
                    <button ng-click="seleccionarTodos(listaEstadoDetenida)" id="todo_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Todos</button>
                    <button ng-click="deseleccionarTodos(listaEstadoDetenida)" id="ninguno_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Ninguno</button>
                </li>     
                <li class="elemento_menu dropdown-divider"></li>
                <li ng-repeat="filtroE in listaEstadoDetenida" class="element-menu-filter"  class="element-menu-filter">
                    <label  class="dropdown-item form-check-inputfiltro">
    ...
    <div class="column-style-consulta" id="fechaFin" style="width: 10%;">
        ...
        <input style="text-align: left;" readonly placeholder="Geografia" ng-click="mostrarArbol(3)" type="text" class="input-filtro-coordInst form-control form-control-sm">
    </div>
    <div class="column-style-consulta" style="width: 10%;">
        <label for="ot_detenida" class="label-filter">OT</label>
        <input type="text" id="ot_detenida" placeholder="Ej: 65434"
        class="form-control input-filtro-coordInst form-control-sm">
    </div>
    <div class="column-style-consulta" style="width: 10%;">
        <label for="os_detenida" class="label-filter">Folio</label>
        <input type="text" id="os_detenida" placeholder="Ej: 23214"
        class="form-control input-filtro-coordInst form-control-sm">
    </div>
    <div class="col-md-1 div-btn-busqueda" style="width: 85px;">
        <button id="btn-detenida-salesforce"  
        ng-click="consultarDetenida()" 
    ...
    <div class="col-12 table-responsive" style="margin-top: 1em;">
        <table id="tableDetenida" class="display table table-hover " cellspacing="0" width="100%">
