        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu drop-down-filters" aria-labelledby="filtro-intervencion">      
                <li style="text-align: center;">
                    <button ng-click="seleccionarTodosRecursivo(filtrosGeneral.estatusDetenida)" id="todo_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Todos</button>
                    <button ng-click="deseleccionarTodosRecursivo(filtrosGeneral.estatusDetenida)" id="ninguno_filtro" type="button" class="btn btn-indigo  btn-sm waves-effect waves-light">Ninguno</button>
                </li>     
                ...
                <li ng-repeat="filtro in filtrosGeneral.estatusDetenida" class="element-menu-filter"  class="element-menu-filter">
                    <label  class="dropdown-item form-check-inputfiltro">
                        <input id="filtrotext-{{filtro.id}}" class="form-check-input" ng-click="setCheckFiltroGenericV2(filtro,filtrosGeneral.estatusDetenida)" type="checkbox" ng-model="filtro.checkedOpcion" ng-true-value="true" ng-false-value="false"/>
