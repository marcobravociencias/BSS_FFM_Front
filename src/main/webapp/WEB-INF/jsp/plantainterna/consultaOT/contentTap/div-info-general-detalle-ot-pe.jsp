		...
		<div class="row">
			<div class="col-md-12">
				<div class="container-fluid vehiculo-content">
					...
					<div class="container-text-content-detalle">
						<span class="text-content-vehiculo"
							title="{{infoOtDetalle.tipoIntervencion}}"
							ng-bind="infoOtDetalle.tipoIntervencion || 'Sin dato'"></span>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="container-fluid vehiculo-content">
					...
					<div class="container-text-content-detalle">
						<span class="text-content-vehiculo"
							title="{{infoOtDetalle.subTipoIntervencion}}"
							ng-bind="infoOtDetalle.subTipoIntervencion || 'Sin dato'"></span>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="container-fluid vehiculo-content">
					...
					<div class="container-text-content-detalle">
						<span class="text-content-vehiculo"
							title="{{infoOtDetalle.descripcionEstatus}}"
		...
		<div class="row">
			<div class="col-md-12">
				<div class="container-fluid vehiculo-content">
					...
					<div class="container-text-content-detalle">
						<span class="text-content-vehiculo"
							title="{{infoOtDetalle.descripcionEstado}}"
		...
		<div class="row">
			<div class="col-md-12">
				<div class="container-fluid vehiculo-content">
					...
					<div class="container-text-content-detalle">
						<span class="text-content-vehiculo"
							title="{{infoOtDetalle.fechaCreacion}}"
							ng-bind="infoOtDetalle.fechaCreacion || 'Sin dato'"></span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="container-fluid vehiculo-content">
					...
					<div class="container-text-content-detalle">
						<span class="text-content-vehiculo"
							title="{{infoOtDetalle.localizacion}}"
							ng-bind="infoOtDetalle.localizacion || 'Sin dato'"></span>
					</div>
				</div>
			</div>
		</div>
