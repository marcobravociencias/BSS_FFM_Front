  ...
  <div class="row">
    ...
    <div class="col-4">
        <div class="container-fluid vehiculo-content">
            <div class="container-title-detail"><span class="text-tile-vehiculo">T&eacute;cnico</span></div>         
        </div>      
        <div class="container-fluid vehiculo-content">
        ...
        <div class="container-fluid vehiculo-content">
            ...
            <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" ng-bind="tecnicoConsultaMateriales.nombreCommpleto || 'Sin dato'"></span>
            </div>
        </div>      
        <div class="container-fluid vehiculo-content">
            ...
            <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" 
                ng-bind="tecnicoConsultaMateriales.numEmpleado || 'Sin dato'"></span>
            </div>
        </div>
        <div class="container-fluid vehiculo-content">
            <div class="container-text-title-detalle"><span class="text-tile-vehiculo">Usuario FFM</span></div>
            <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" 
                ng-bind="tecnicoConsultaMateriales.usuario || 'Sin dato'"></span>
            </div>
        </div> 
        <div class="container-fluid vehiculo-content">
        ...
        <div class="container-fluid vehiculo-content">
            ...
            <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" ng-bind="tecnicoConsultaMateriales.claveCliente || 'Sin dato'"></span>
            </div>
        </div>              
    </div>  
    <div class="col-4">
        <div class="container-fluid vehiculo-content">
            <div class="container-title-detail"><span class="text-tile-vehiculo">Orden</span></div>         
        </div>      
        <div class="container-fluid vehiculo-content">
            <div class="divider-materiales-centroalmacen">
            </div>
        ...
        <div class="container-fluid vehiculo-content">
            <div class="container-text-title-detalle"><span class="text-tile-vehiculo">Id orden</span></div>
            <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" ng-bind="tecnicoConsultaMateriales.idOrden || 'Sin dato'"></span>
            </div>
        </div>      
        <div class="container-fluid vehiculo-content">
            <div class="container-text-title-detalle"><span class="text-tile-vehiculo">Folio</span></div>
            <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" 
                ng-bind="tecnicoConsultaMateriales.folioSistema || 'Sin dato'"></span>
            </div>
        </div>
        <div class="container-fluid vehiculo-content">
        ...
        <div class="container-fluid vehiculo-content">
          <div class="container-text-title-detalle"><span class="text-tile-vehiculo">Num. ticket</span></div>
          <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" ng-bind="tecnicoConsultaMateriales.numTicket || 'Sin dato'"></span>
          </div>
        </div>
        <div class="container-fluid vehiculo-content">
          <div class="container-text-title-detalle"><span class="text-tile-vehiculo">Latitud</span></div>
          <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" ng-bind="tecnicoConsultaMateriales.latitud || 'Sin dato'"></span>
          </div>
        </div>   
        <div class="container-fluid vehiculo-content">
            <div class="container-text-title-detalle"><span class="text-tile-vehiculo">Longitud</span></div>
            <div class="container-text-content-detalle"><span class="text-content-vehiculo ng-binding" ng-bind="tecnicoConsultaMateriales.longitud || 'Sin dato'"></span>
            </div>
        </div>  
...
<div class="row">
    <div class="col-12">
        <table id="table-materiales-ot" class="table table-materiales table-sm table-responsive" cellspacing="0" width="100%">
            <thead  >
                <tr >
                    <th scope="col">Sku</th>
