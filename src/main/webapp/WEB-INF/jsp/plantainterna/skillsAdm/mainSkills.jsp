			...
			<div id="divContenedorIndividual"
				...
				<div id="divContenedorTecnicos" class="col-md-4">
					...
					<div class="tecnicos-container">
						...
						<div id="divMensajeSeleccionaGeografia" class="content-noseleccion">
							<i class="icono-noseleccion fas fa-exclamation-circle me-2"></i> <b
								class="text-no-seleccion-geografia">Selecciona una geograf�a</b>
						</div>
					</div>
				</div>
				<div id="divSkills" class="col-md-5">
					...
					<div id="divMensajeSeleccionaTecnico" class="content-noseleccion">
						<i class="icono-noseleccion fas fa-exclamation-circle me-2"></i> <b
							class="text-no-seleccion-geografia">Selecciona un t�cnico</b>
					</div>
					...
					<div class="modal-dialog modal-xl">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Multiselecci�n</h5>
			...
			<div id="divContenedorTabla" class="row content-gestion-operarios" style="display: none">
					...
					<nav
						...
						<ul class="ul-elementos-nav navbar-nav">
							<li id="li-consultaot-navbar" class="nav-item"><i
								...
								ng-click="abrirModalGeografiaTabla()">Geograf�a</a></li>
						</ul>
					</nav>
					<nav
						class="navbar navbar-expand-lg navbar-light bg-light navbar-menu-generic"
				...
				<div id="contenedorTablaSkilssVistaTabla" class="" style="display: none;">
					<div class="row">
						<div class="col-md-3">
							<div class="input-group input-group-sm content-seach-group  ">
								<input type="text" id="idBuscadorTecnicoTabla" class="form-control form-control-sm buscar-input-operario" ng-keyup="busquedaTecnicoTabla()" placeholder="Buscar T�cnico">
				...
				<div id="modalGeografiaTabla" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Geograf�a</h5>
