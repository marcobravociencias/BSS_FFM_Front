		...
		<div class="container-fluid">
			<div class="row md-form" id="filters-dispo">
				<div class="col-sm-2 columna-filtro-ind" data-step="11"
					...
					<label for="compania_select" class="label-filter">Compa&ntilde;&iacute;a</label>&nbsp;<i class="icono-noseleccion fas fa-exclamation-circle me-2" title="No se encontraron catalogo de Geografia" ng-show="false"></i>
				...
				<div id="container_arbol_dispo_consulta" class="col-sm-2 columna-filtro-ind"
					data-intro="Opci&oacute;n tipo de intervenci&oacute;n">
					<i class="icono-noseleccion fas fa-exclamation-circle me-2" title="No se encontro el catalogo de Geografia" ng-show="banderaErrorGeografia"></i><label for="arbol_disponibilidad_consulta" class="label-filter">Geograf&iacute;a</label>
				...
				<div class="col-1" style="margin-top: 1.5px;">
