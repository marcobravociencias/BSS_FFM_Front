    ...
    <div class="offset-1 col-md-6">
        ...
        <div class="col-md-12">
            ...
            <div id="contenedorIntervencionesRegistro" class="scrollGeneralArbol">
	        	<div class="row padding_resumen_ciudades" ng-repeat="intervencion in intervencionSelect track by $index">
	            	<div class="col-md-6">
	                	<span class="text-body-table-arbol" ng-bind="intervencion.text"></span>
					</div>
	                <div class="col-md-6">
