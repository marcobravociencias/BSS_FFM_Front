...
<div class="row contenedorRowForm">
    <div class="col-md-4">
        ...
        <div class="">
        	<input type="text" class="form-control inputFormulario" ng-model="informacionRegistro.usuario" id="form-usuario" aria-describedby="basic-addon3" style="height: 34px;" placeholder="Ej. PIRESIDENCIAL">
        </div>
    </div>
    <div class="col-md-4">
