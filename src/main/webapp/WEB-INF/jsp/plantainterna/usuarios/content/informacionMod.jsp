...
<div class="row contenedorRowForm">
    <div class="col-md-4">
        ...
        <div class="">
        	<input type="text" class="form-control inputFormulario" ng-model="detalleUsuario.usuario" id="form-usuario-mod" ng-keyup="quitarEspaciosNombreUsuario('form-usuario-mod')" aria-describedby="basic-addon3" style="height: 34px;" placeholder="Ej. PIRESIDENCIAL">
        </div>
    </div>
    <div class="col-md-4">
