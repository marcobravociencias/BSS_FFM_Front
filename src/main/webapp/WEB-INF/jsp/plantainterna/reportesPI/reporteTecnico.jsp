<div class="container-fluid container-tab">
    <div class="container-filtros">
        <div class="row md-form" id="filtros_config">
            <div class="col-md-1 column-style-consulta borderFilterR borderAlignR" id="borderAlignt">
            ...
            <div class="col-md-2 column-style-consulta borderFilterR">
                <input type="text" placeholder="JEFE INMEDIATO" id="jInm"
                    class="form-control input-filtro form-control-sm">
            </div>
            ...
            <div class="col-md-1 columna-filtro-indR borderFilterR">
                <input readonly placeholder="Fecha Inicial" type="text" id="filtro_fecha_inicio_consultaOtT"
                    class="datepicker input-filtro form-control form-control-sm" />
            </div>
            <div class="col-md-1 columna-filtro-indR borderFilterR">
                <input readonly placeholder="Fecha Final" type="text" id="filtro_fecha_fin_consultaOtT"
                    class="datepicker input-filtro form-control form-control-sm" />
            </div>
            <div class="col-1 div-btn-busqueda borderFilterR" style="width: 45px;">
                <button id="btn_consultar_ordenes" type="button"
                    class="btn btn-sm  btn-primary  waves-effect waves-light btn_consultar"
                    style="margin-top: 0; margin: 0 !important;" ng-click="consultarReporteTecnico()">
    ...
    <div class="content-table">
        <div class="content-fluid">
            <table id="reporteTecnicoTable" class="display table table-hover " cellspacing="0" width="100%">
                <thead id="thead_reporteTecnico">
                    <tr>
                        <th>OT</th>
                        <!-- <th>OS</th> -->
                        <th>CLIENTE</th>
