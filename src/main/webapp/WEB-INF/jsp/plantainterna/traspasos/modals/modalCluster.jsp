					...
					<div class="row">
						<div class="col-md-12" style="padding: 0;">
							...
							<div class="input-group input-group-sm content-seach-group"
								ng-show="tipoArbol === 'traspaso'">
								<input id="searchGeografiaTraspaso" type="text" class="form-control buscadorGenerico"
									placeholder="Buscar geograf&iacute;a">
								<span class="fa fa-search iconoBusqueda"></span>
							</div>
							<div class="input-group input-group-sm content-seach-group"
								ng-show="tipoArbol === 'historico'">
								<input id="searchGeografiaHistorico" type="text" class="form-control buscadorGenerico"
									placeholder="Buscar geograf&iacute;a">
								<span class="fa fa-search iconoBusqueda"></span>
							</div>
						</div>
						<div class="col-md-12">
							...
							<div id="jstree-proton-ht" class="proton-demo" ng-show="tipoArbol === 'historico'"></div>
						</div>
					</div>
				</div>
