                    ...
                    <div class="row">
                        <div style="padding-left: 0;" class="col-2">
                            <div class="nav flex-column nav-tabs text-center" id="v-tabs-tab-detalle-ot" role="tablist"
                                ...
                                <a data-mdb-toggle="tab" href="#content-ot" class="nav-link active"
                                    id="informacion-ot">Informaci&oacute;n</li>
                                    <a ng-click="consultaHistoricoOt()" data-mdb-toggle="tab" href="#content-historico"
                                        ng-show="permisosModal.indexOf('tabHistoricoDespacho') !== -1" class="nav-link"
                                        id="info_historico">Hist&oacute;rico</a>
                                    <a ng-click="consultaChat()" data-mdb-toggle="tab" href="#content-comentarios"
                                        ng-show="permisosModal.indexOf('tabComentariosDespacho') !== -1"
                                        class="nav-link" id="comentarios">Comentarios</a>
                            </div>
                        </div>
                        ...
                        <div class="col-10">
                            <div class="tab-content">
                                <div class="contenedor_detalle row tab-pane fade show active" id="content-ot"
                                    role="tabpanel" aria-labelledby="v-tabs-consulta-acciones-tab">
                                    <div class="row">
                                        <div class="col-6">
