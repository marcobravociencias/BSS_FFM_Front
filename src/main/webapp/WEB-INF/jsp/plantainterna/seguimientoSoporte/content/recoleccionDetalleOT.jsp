        ...
        <div class="col-4">
            ...
            <div class="container-fluid detalle-ot-content">
                ...
                <div class="container-text-content-detalle">
                    <span class="text-content-detalle-ot"
                        title="{{tecnicoConsultaRecoleccion.nombre+' '+tecnicoConsultaRecoleccion.apellidoPaterno+' '+tecnicoConsultaRecoleccion.apellidoMaterno || 'Sin dato'}}"
                        ng-bind="tecnicoConsultaRecoleccion.nombre+' '+tecnicoConsultaRecoleccion.apellidoPaterno+' '+tecnicoConsultaRecoleccion.apellidoMaterno || 'Sin dato'"></span>
                </div>
            </div>
            <div class="container-fluid detalle-ot-content">
                <div class="container-text-title-detalle">
                ...
                <div class="container-text-content-detalle">
                    <span class="text-content-detalle-ot"
                        title="{{tecnicoConsultaRecoleccion.numeroEmpleado || 'Sin dato'}}"
                        ng-bind="tecnicoConsultaRecoleccion.numeroEmpleado || 'Sin dato'"></span>
                </div>
            </div>
            <div class="container-fluid detalle-ot-content">
                <div class="container-text-title-detalle">
                ...
                <div class="container-text-content-detalle">
                    <span class="text-content-detalle-ot"
                        title="{{tecnicoConsultaRecoleccion.usuarioFFM || 'Sin dato'}}"
                        ng-bind="tecnicoConsultaRecoleccion.usuarioFFM || 'Sin dato'"></span>
                </div>
            </div>
        </div>
        <div class="col-4">
                ...
                <table id="tableRecoleccionDetalleOT" class="display table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center !important;">Recuperado</th>
                            <th style="text-align: center !important;">Adicional</th>
