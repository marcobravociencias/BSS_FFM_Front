...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/libraries/alertify/css/alertify.min.css">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/plantainterna/ordenesUniversales/styleOrdenesUniversales.css?v=${sessionScope.versionDepl}">
</head>
