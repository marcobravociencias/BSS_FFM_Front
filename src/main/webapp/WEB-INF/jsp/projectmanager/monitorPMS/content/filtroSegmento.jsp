<div class="content-fluid" ng-show="mostrarfiltro">
    <div class="container-noticia-elemento">
        <ul class="nav nav-tabs" id="myTab">
            ...
            <div class="col-4 col-btn-cerrar-filtro">
                <button type="button" class="close" id="closeDetalleTicket" ng-click="openfiltro()">
        ...
        <div class="tab-content" id="myTabContent">
                ...
                <div class="row container-columnas-filtro">
                    <div class="container-fluid filtro-content">
                        ...
                        <div class="container-text-content-filtro form-check form-switch">
                            <input id="checkTodoColumnaSinSegmento" class="form-check-input" type="checkbox" ng-click="aplicarTodoColumnaDetalle()">
                        </div>
                    </div>
                    <div class="container-fluid filtro-content" ng-repeat="filter in encabezadosList track by $index" ng-if="$index != 0 && $index != 1">
                        <div class="container-text-title-detalle"><span class="text-tile-filtro">{{filter.titulo.toUpperCase()}}</span></div>
                        <div class="container-text-content-filtro form-check form-switch">
                            <input class="form-check-input" type="checkbox" ng-model="filter.vista" ng-click="aplicarTodoColumna()">
                        </div>
                    </div>
            ...
            <div class="tab-pane fade show" id="filtradoPorSegmento" role="tabpanel" aria-labelledby="detalleTicket-tab">
                <div class="divider-noticias" style=" width: 100%;height: 1px; background: gainsboro;"></div>
                <div class="row container-columnas-filtro">
                    <div class="container-fluid filtro-content" ng-repeat="filter in filtroPorList" ng-if="$index != 0 && $index != 1 && filter.vista">
                        <div class="container-text-title-detalle"><span class="text-tile-filtro">{{filter.titulo.toUpperCase()}}</span></div>
