    ...
    <div style="padding: 0" class="col-12">
        <div class="table-responsive">
            <div class="col-4" style="text-align: center;">
                <div ng-show="!detallePagoObj.isPagosPendientes"
                    class="card-icon icon-primary estatus-container-pagos">
                    <i class="fas fa-check"></i> <span class="sin-pagos-pendientes">
                        Sin pagos pendientes
                    </span>
                </div>
                <div ng-show="detallePagoObj.isPagosPendientes"
                    class="card-icon icon-primary estatus-container-pagos-pendiente">
            ...
            <table id="table_pagos_ot" class="display table" cellspacing="0" width="100%">
